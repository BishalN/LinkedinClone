...
export const YearSelector: React.FC<SelectorProps> = (props) => {
  return (
    <select name='year' {...props}>
...
export const EmploymentSelector: React.FC<SelectorProps> = (props) => {
  return (
    <select name='employment' {...props}>
...
export const IndustrySelector: React.FC<SelectorProps> = (props) => {
  return (
    <select name='industry' {...props}>
      ...
      <option value='Computer Networking'>Computer Software</option>
